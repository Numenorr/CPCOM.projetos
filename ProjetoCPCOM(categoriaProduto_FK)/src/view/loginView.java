...
public class loginView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel_cadastro.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        jLabel_cadastro.setForeground(new java.awt.Color(0, 0, 204));
        jLabel_cadastro.setText("Cadastre-se");
        jLabel_cadastro.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jLabel_cadastro.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLabel_cadastroMouseClicked(evt);
            }
        });
    ...
    private void jLabel_cadastroMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel_cadastroMouseClicked
        cadastroUsuarioView cadastro = new cadastroUsuarioView();
        cadastro.setVisible(true);
    }//GEN-LAST:event_jLabel_cadastroMouseClicked

    private void jButton_loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_loginActionPerformed
        
        if(usuController.verificaLogin(jTextField_user.getText(), new String(
